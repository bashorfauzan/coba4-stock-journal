...
class PreferenceStore(context: Context) {
    ...
    fun getLastWebAppStatus(): String =
        prefs.getString(KEY_LAST_WEB_APP_STATUS, DEFAULT_WEB_APP_STATUS) ?: DEFAULT_WEB_APP_STATUS

    fun setLastWebAppStatus(value: String) {
        prefs.edit().putString(KEY_LAST_WEB_APP_STATUS, value).apply()
    }

    companion object {
        private const val PREFS_NAME = "coba4_stock_helper"
